...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FlatTreeAnalyzer(TString in, TString out, TString weight = "", int index = -1, TTree *tree=0);
...
FlatTreeAnalyzer::FlatTreeAnalyzer(TString InputFile, TString OutputFile, TString Weights, int index, TTree *tree) : fChain(0) 
{
